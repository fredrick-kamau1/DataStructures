...
public class ArrayStackTester {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Push number 3");
    myStack.push(3);
    System.out.println("Test peek [3]. Method returned: " + myStack.peek());
    ...
    System.out.println("Push number 12");
    myStack.push(12);
    System.out.println("Test peek [12]. Method returned: " + myStack.peek());
    ...
    System.out.println("Test peek [7] " + myStack.peek() + ". Stack Length: "
        + myStack.length());
